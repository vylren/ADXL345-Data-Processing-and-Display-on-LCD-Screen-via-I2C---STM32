# 1 "../Core/Src/stm32l0xx_hal_msp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Core/Src/stm32l0xx_hal_msp.c" 2
# 22 "../Core/Src/stm32l0xx_hal_msp.c"
# 1 "../Core/Inc\\main.h" 1
# 30 "../Core/Inc\\main.h"
...
# 23 "../Core/Src/stm32l0xx_hal_msp.c" 2
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x00005400UL)))
  {
    ...
    GPIO_InitStruct.Pin = (0x0100U)|(0x0200U);
    ...
    HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000400UL)), &GPIO_InitStruct);
  ...
  else if(hi2c->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x00007800UL)))
  {
    ...
    GPIO_InitStruct.Pin = (0x0200U);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x1UL << 4U));
    GPIO_InitStruct.Pull = (0x00000000U);
    GPIO_InitStruct.Speed = (0x00000003U);
    GPIO_InitStruct.Alternate = ((uint8_t)0x07U);
    HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000800UL)), &GPIO_InitStruct);

    GPIO_InitStruct.Pin = (0x0100U);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x1UL << 4U));
    GPIO_InitStruct.Pull = (0x00000000U);
    GPIO_InitStruct.Speed = (0x00000003U);
    GPIO_InitStruct.Alternate = ((uint8_t)0x07U);
    HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000000UL)), &GPIO_InitStruct);


    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= (((0x1UL << (30U)))));
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x00005400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000400UL)), (0x0100U));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000400UL)), (0x0200U));
  ...
  else if(hi2c->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x00007800UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000800UL)), (0x0200U));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000000UL)), (0x0100U));
...
{
  if(htim_base->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x00001000UL)))
  {




    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= (((0x1UL << (4U)))));
  ...
  else if(htim_base->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x00001400UL)))
  {




    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= (((0x1UL << (5U)))));
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x00004400UL)))
  {
    ...
    GPIO_InitStruct.Pin = (0x0004U)|(0x0008U);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==((USART_TypeDef *) ((0x40000000UL) + 0x00004400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x10000000UL) + 0x00000000UL)), (0x0004U)|(0x0008U));
