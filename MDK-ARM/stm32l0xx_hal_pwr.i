...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr.c" 2
# 26 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr.c"
...
# 27 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr.c" 2
...
void HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR) &= ~((0x1UL << (16U))));
  ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR) &= ~((0x1UL << (16U))));
  ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR) &= ~((0x1UL << (16U))));
  ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR) &= ~((0x1UL << (16U))));
...
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CSR) |= (WakeUpPinx));
}
...
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ...
  ulpbit = ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR) & ((0x1UL << (9U))));
  vrefinbit = ((((SYSCFG_TypeDef *) ((0x40000000UL) + 0x00010000UL))->CFGR3) & ((0x1UL << (0U))));
  if((ulpbit != 0) && (vrefinbit != 0))
  {
    ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR) &= ~((0x1UL << (9U))));
  }


  tmpreg = ((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR;


  ((tmpreg) &= ~(((0x1UL << (1U)) | (0x1UL << (0U)))));


  ((tmpreg) |= (Regulator));


  ((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR = tmpreg;
...
void HAL_PWR_PVD_IRQHandler(void)
{
  ...
  if((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->PR & ((0x1UL << (16U)))) != RESET)
  {

    HAL_PWR_PVDCallback();


    (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->PR = ((0x1UL << (16U))));
  }
}
