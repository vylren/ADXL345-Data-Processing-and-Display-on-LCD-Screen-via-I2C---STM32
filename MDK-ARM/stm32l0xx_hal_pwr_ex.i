...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr_ex.c" 2
# 25 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr_ex.c"
...
# 26 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr_ex.c" 2
# 69 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr_ex.c"
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR & (0x3UL << (11U)));
}
# 82 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_pwr_ex.c"
void HAL_PWREx_EnableFastWakeUp(void)
{

  ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR) |= ((0x1UL << (10U))));
}
...
void HAL_PWREx_EnableLowPowerRunMode(void)
{
  ...
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR) |= ((0x1UL << (0U))));
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CR) |= ((0x1UL << (14U))));
}
...
HAL_StatusTypeDef HAL_PWREx_DisableLowPowerRunMode(void)
{
  ...
  wait_loop_index = (50U * (SystemCoreClock / 1000000U));

  while ((wait_loop_index != 0U) && ((((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CSR) & ((0x1UL << (5U)))) == ((0x1UL << (5U))))))
  {
    wait_loop_index--;
  }

  if ((((((PWR_TypeDef *) ((0x40000000UL) + 0x00007000UL))->CSR) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))))
  {
    return HAL_TIMEOUT;
  }
