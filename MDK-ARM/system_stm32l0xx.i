...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Core/Src/system_stm32l0xx.c" 2
...
# 26 "../Drivers/STM32L0xx_HAL_Driver/Inc\\stm32l0xx_hal_exti.h"
# 1 "../Drivers/CMSIS/Device/ST/STM32L0xx/Include\\stm32l0xx.h" 1
# 27 "../Drivers/STM32L0xx_HAL_Driver/Inc\\stm32l0xx_hal_exti.h" 2
...
# 48 "../Core/Src/system_stm32l0xx.c" 2
...
void SystemCoreClockUpdate (void)
{
  ...
  {
    case 0x00U:
      msirange = (((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->ICSCR & (0x7UL << (13U))) >> (13U);
      SystemCoreClock = (32768U * (1U << (msirange + 1U)));
      break;
    case 0x04U:
      if ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->CR & (0x1UL << (4U))) != 0U)
      {
        SystemCoreClock = ((uint32_t)16000000U) / 4U;
      }
      else
      {
    ...
    default:
      ...
      if (pllsource == 0x00U)
      {
        ...
        if ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->CR & (0x1UL << (4U))) != 0U)
        {
          SystemCoreClock = (((((uint32_t)16000000U) / 4U) * pllmul) / plldiv);
        }
        else
        {
          SystemCoreClock = (((((uint32_t)16000000U)) * pllmul) / plldiv);
        }
      }
      else
      {

        SystemCoreClock = (((((uint32_t)8000000U)) * pllmul) / plldiv);
      }
      break;
  }
