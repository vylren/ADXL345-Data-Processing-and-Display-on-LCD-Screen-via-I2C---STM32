...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_cortex.c" 2
# 78 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_cortex.c"
...
# 79 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_cortex.c" 2
...
void HAL_MPU_ConfigRegion(MPU_Region_InitTypeDef *MPU_Init)
{
  ...
  if ((MPU_Init->Enable) == ((uint8_t)0x01))
  {
    ...
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RBAR = (MPU_Init->BaseAddress) & 0xfffffff0U;
