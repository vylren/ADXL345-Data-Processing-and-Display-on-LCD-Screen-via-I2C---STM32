...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c" 2
...
# 159 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c" 2
# 196 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
...
# 327 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
...
HAL_StatusTypeDef HAL_UART_Transmit_IT(UART_HandleTypeDef *huart, const uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->gState == 0x00000020U)
  {
    ...
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (7U))))); __set_PRIMASK(primask); } while(0);
...
HAL_StatusTypeDef HAL_UART_Receive_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->RxState == 0x00000020U)
  {
    ...
    if (!(((huart->Instance) == ((USART_TypeDef *) ((0x40000000UL) + 0x00004800UL)))))
    {

      if (((huart->Instance->CR2) & ((0x1UL << (23U)))) != 0U)
      {

        do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (26U))))); __set_PRIMASK(primask); } while(0);
      }
    }
...
HAL_StatusTypeDef HAL_UART_Transmit_DMA(UART_HandleTypeDef *huart, const uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->gState == 0x00000020U)
  {
    ...
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) |= (((0x1UL << (7U))))); __set_PRIMASK(primask); } while(0);
...
# 1496 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_Receive_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
HAL_StatusTypeDef HAL_UART_DMAPause(UART_HandleTypeDef *huart)
{
      ...
      (rxstate == 0x00000022U))
  {
    ...
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~(((0x1UL << (8U))))); __set_PRIMASK(primask); } while(0);
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) &= ~(((0x1UL << (0U))))); __set_PRIMASK(primask); } while(0);


    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) &= ~(((0x1UL << (6U))))); __set_PRIMASK(primask); } while(0);
  }
...
HAL_StatusTypeDef HAL_UART_Abort(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~((((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U)))))); __set_PRIMASK(primask); } while(0);
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) &= ~(((0x1UL << (0U))))); __set_PRIMASK(primask); } while(0);


  if (huart->ReceptionType == (0x00000001U))
  {
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~((((0x1UL << (4U)))))); __set_PRIMASK(primask); } while(0);
  }
...
# 1776 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_AbortTransmit(UART_HandleTypeDef *huart)
{

  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~((((0x1UL << (7U)) | (0x1UL << (6U)))))); __set_PRIMASK(primask); } while(0);
...
HAL_StatusTypeDef HAL_UART_AbortReceive(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~((((0x1UL << (5U)) | (0x1UL << (8U)))))); __set_PRIMASK(primask); } while(0);
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) &= ~(((0x1UL << (0U))))); __set_PRIMASK(primask); } while(0);
...
# 2129 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef HAL_UART_AbortReceive_IT(UART_HandleTypeDef *huart)
{
...
HAL_StatusTypeDef HAL_MultiProcessor_EnableMuteMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (13U))))); __set_PRIMASK(primask); } while(0);
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableTransmitter(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) &= ~((((0x1UL << (3U)) | (0x1UL << (2U)))))); __set_PRIMASK(primask); } while(0);


  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (3U))))); __set_PRIMASK(primask); } while(0);
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableReceiver(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (2U))))); __set_PRIMASK(primask); } while(0);
  ...
  if (((((huart)->Instance) == ((USART_TypeDef *) ((0x40000000UL) + 0x00004800UL)))))
  {
    ...
    switch (clocksource)
    {
      ...
      case UART_CLOCKSOURCE_HSI:
        if ((((((((((((uint8_t)((((uint8_t)1) << 5) | (4U)))) >> 5) == ((uint8_t)1))? ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->CR :((((((uint8_t)((((uint8_t)1) << 5) | (4U)))) >> 5) == ((uint8_t)2)) ? ((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->CSR :((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->CRRCR)))) & ((uint32_t)1 << ((((uint8_t)((((uint8_t)1) << 5) | (4U)))) & ((uint8_t)0x1F)))) != 0U ) ? 1U : 0U ) != 0U)
        {
          pclk = (uint32_t)(((uint32_t)16000000U) >> 2U);
        }
        else
        {
...
# 3354 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef UART_WaitOnFlagUntilTimeout(UART_HandleTypeDef *huart, uint32_t Flag, FlagStatus Status,
                                              uint32_t Tickstart, uint32_t Timeout)
{
...
# 3422 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef UART_Start_Receive_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->Init.Parity != 0x00000000U)
  {
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (8U)) | (0x1UL << (5U))))); __set_PRIMASK(primask); } while(0);
  }
  else
  {
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (5U))))); __set_PRIMASK(primask); } while(0);
  }
  return HAL_OK;
}
# 3471 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
HAL_StatusTypeDef UART_Start_Receive_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  huart->pRxBuffPtr = pData;
  huart->RxXferSize = Size;
...
static void UART_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((((hdma->Instance->CCR) & ((0x1UL << (5U)))) == 0U))
  {
    ...
    do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (6U))))); __set_PRIMASK(primask); } while(0);
  }
...
# 3783 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_DMATxAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)(hdma->Parent);
...
# 3833 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_DMARxAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)(hdma->Parent);
...
# 3885 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_DMATxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
  UART_HandleTypeDef *huart = (UART_HandleTypeDef *)(hdma->Parent);
...
# 3913 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_DMARxOnlyAbortCallback(DMA_HandleTypeDef *hdma)
{
...
# 3946 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_TxISR_8BIT(UART_HandleTypeDef *huart)
{
...
# 3975 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_TxISR_16BIT(UART_HandleTypeDef *huart)
{
  const uint16_t *tmp;
...
# 4007 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_EndTransmit_IT(UART_HandleTypeDef *huart)
{
...
# 4123 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart.c"
static void UART_RxISR_16BIT(UART_HandleTypeDef *huart)
{
  uint16_t *tmp;
  uint16_t uhMask = huart->Mask;
