...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c" 2
# 323 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
...
# 324 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c" 2
# 420 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
...
# 580 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do{ (hi2c)->Lock = HAL_UNLOCKED; }while (0);
# 1873 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
                                             ...
                                             uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    else
    {
      ...
      do{ (hi2c)->Lock = HAL_UNLOCKED; }while (0);
# 2166 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
      I2C_Enable_IRQ(hi2c, (uint16_t)(0x0001U));
    }
...
# 2321 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Receive_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
# 2704 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Mem_Write_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress,
                                       uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do{ (hi2c)->Lock = HAL_UNLOCKED; }while (0);
# 2769 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
    I2C_Enable_IRQ(hi2c, (uint16_t)(0x0001U));
...
# 3169 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_IsDeviceReady(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Trials,
                                        uint32_t Timeout)
{
  uint32_t tickstart;
...
# 3823 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size,
                                                uint32_t XferOptions)
{
...
# 4107 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Receive_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size,
                                               uint32_t XferOptions)
{
...
# 4444 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Master_Abort_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress)
{
...
# 4953 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Mem_ISR_IT(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                        uint32_t ITSources)
{
...
# 5090 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Slave_ISR_IT(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                          uint32_t ITSources)
{
...
# 5231 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Master_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                            uint32_t ITSources)
{
  uint16_t devaddress;
...
# 5371 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Mem_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                         uint32_t ITSources)
{
  uint32_t direction = (uint32_t)(0x80000000U | (0x1UL << (13U)));
...
# 5510 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_Slave_ISR_DMA(struct __I2C_HandleTypeDef *hi2c, uint32_t ITFlags,
                                           uint32_t ITSources)
{
  uint32_t tmpoptions = hi2c->XferOptions;
...
# 5655 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_RequestMemoryWrite(I2C_HandleTypeDef *hi2c, uint16_t DevAddress,
                                                uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                                uint32_t Tickstart)
{
...
# 5710 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_RequestMemoryRead(I2C_HandleTypeDef *hi2c, uint16_t DevAddress,
                                               uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                               uint32_t Tickstart)
{
...
# 6703 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static void I2C_DMAAbort(DMA_HandleTypeDef *hdma)
{
...
# 6733 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, FlagStatus Status,
                                                    uint32_t Timeout, uint32_t Tickstart)
{
...
# 6767 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnTXISFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
...
# 6808 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnSTOPFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
...
# 6846 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnRXNEFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
...
# 6922 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
...
# 7063 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static void I2C_TransferConfig(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t Size, uint32_t Mode,
                               uint32_t Request)
{
...
# 7090 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static void I2C_Enable_IRQ(I2C_HandleTypeDef *hi2c, uint16_t InterruptRequest)
{
  uint32_t tmpisr = 0U;
  ...
  else
  {
    ...
    if ((hi2c->XferISR != I2C_Mem_ISR_DMA) && (InterruptRequest == (uint16_t)(0x0040U)))
    {
...
# 7181 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_i2c.c"
static void I2C_Disable_IRQ(I2C_HandleTypeDef *hi2c, uint16_t InterruptRequest)
{
  uint32_t tmpisr = 0U;
