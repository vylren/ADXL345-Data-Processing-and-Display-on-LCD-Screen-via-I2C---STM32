...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c" 2
# 43 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
...
# 44 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c" 2
...
static HAL_StatusTypeDef FLASHRAM_WaitForLastOperation(uint32_t Timeout);
static HAL_StatusTypeDef FLASHRAM_SetErrorCode(void);
# 113 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
           HAL_StatusTypeDef HAL_FLASHEx_EnableRunPowerDown(void)
{

  do { ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PDKEYR = (0x04152637U); ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PDKEYR = (0xFAFBFCFDU); (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->ACR)) |= ((0x1UL << (4U)))); } while (0);
...
# 163 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
           HAL_StatusTypeDef HAL_FLASHEx_EraseParallelPage(uint32_t Page_Address1, uint32_t Page_Address2)
{
  HAL_StatusTypeDef status = HAL_OK;


  status = FLASHRAM_WaitForLastOperation((50000U));

  if(status == HAL_OK)
  {

    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (15U))));
    ...
    *(volatile uint32_t *)Page_Address1 = 0x00000000U;

    *(volatile uint32_t *)Page_Address2 = 0x00000000U;
...
# 222 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
           HAL_StatusTypeDef HAL_FLASHEx_ProgramParallelHalfPage(uint32_t Address1, uint32_t* pBuffer1, uint32_t Address2, uint32_t* pBuffer2)
{
  uint32_t count = 0U;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    ...
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (15U))));
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (10U))));
    ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (3U))));
    ...
    if(status == HAL_OK)
    {
      ...
      while(count < 16U)
      {
        ...
        *(volatile uint32_t*) Address1 = *pBuffer1;
        pBuffer1++;
        count ++;
      }
      ...
      while(count < 16U)
      {
        ...
        *(volatile uint32_t*) Address2 = *pBuffer2;
        pBuffer2++;
        count ++;
      }
...
# 303 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
           HAL_StatusTypeDef HAL_FLASHEx_HalfPageProgram(uint32_t Address, uint32_t* pBuffer)
{
  uint32_t count = 0U;
  HAL_StatusTypeDef status = HAL_OK;
  ...
  if(status == HAL_OK)
  {
    ...
    while(count < 16U)
    {
      ...
      *(volatile uint32_t*) Address = *pBuffer;
      pBuffer++;
      count ++;
    }
...
# 374 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
           HAL_StatusTypeDef HAL_FLASHEx_GetError(uint32_t * Error)
{
...
static HAL_StatusTypeDef FLASHRAM_SetErrorCode(void)
{
  ...
  {
# 425 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
...
static HAL_StatusTypeDef FLASHRAM_WaitForLastOperation(uint32_t Timeout)
{
    ...
    while((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) && (Timeout != 0x00U))
    {
      Timeout--;
    }
  ...
  {
# 497 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ramfunc.c"
