...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c" 2
...
# 50 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c" 2
...
# 166 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  ...
  if (status == HAL_OK)
  {
    ...
    *PageError = 0xFFFFFFFFU;
    ...
    for(address = pEraseInit->PageAddress;
        address < ((pEraseInit->NbPages * (128U)) + pEraseInit->PageAddress);
        address += (128U))
    {
      ...
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) &= ~((0x1UL << (3U))));
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) &= ~((0x1UL << (9U))));
...
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef *pEraseInit)
{
  ...
  if (status == HAL_OK)
  {
    ...
    (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR)) |= (((0x1UL << (16U)) | (0x1UL << (17U)))));
...
# 322 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  HAL_StatusTypeDef status = HAL_ERROR;
  ...
  {
    status = FLASH_OB_UserConfig(pOBInit->USERConfig & ((uint8_t)0x10),
                                 pOBInit->USERConfig & ((uint8_t)0x20),
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = (0x01U) | (0x02U) | (0x04U) | (0x08U);
...
HAL_StatusTypeDef HAL_FLASHEx_AdvOBProgram (FLASH_AdvOBProgramInitTypeDef *pAdvOBInit)
{
  ...
  if ((pAdvOBInit->OptionType & (0x01U)) == (0x01U))
  {
  ...
  if ((pAdvOBInit->OptionType & (0x02U)) == (0x02U))
  {
...
void HAL_FLASHEx_AdvOBGetConfig(FLASH_AdvOBProgramInitTypeDef *pAdvOBInit)
{
  ...
  pAdvOBInit->OptionType |= (0x01U);



  pAdvOBInit->PCROPState = (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR & (0x1UL << (8U))) >> (8U);

  pAdvOBInit->PCROPSector = ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->WRPR;



  pAdvOBInit->PCROPSector2 = ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->WRPR2;





  pAdvOBInit->OptionType |= (0x02U);


  pAdvOBInit->BootConfig = (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR & (0x1UL << (23U))) >> 16U;
...
HAL_StatusTypeDef HAL_FLASHEx_OB_SelectPCROP(void)
{
  ...
  optiontmp = (uint8_t)(*(volatile uint8_t *)((0x1FF80000UL)));


  optiontmp2 = (uint16_t)(((uint16_t)(0x1UL << (8U))) | optiontmp);
  ...
  if(status == HAL_OK)
  {
    ...
    ((OB_TypeDef *) (0x1FF80000UL))->RDP = tmp2;
...
HAL_StatusTypeDef HAL_FLASHEx_OB_DeSelectPCROP(void)
{
  ...
  optiontmp2 = (uint16_t)(((uint16_t)0x0000) | optiontmp);
...
HAL_StatusTypeDef HAL_FLASHEx_DATAEEPROM_Unlock(void)
{
  ...
  if((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR & (0x1UL << (0U))) != RESET)
  {
    ...
    ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PEKEYR = (0x89ABCDEFU);
    ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PEKEYR = (0x02030405U);
...
HAL_StatusTypeDef HAL_FLASHEx_DATAEEPROM_Lock(void)
{
  ...
  ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (0U))));
...
HAL_StatusTypeDef HAL_FLASHEx_DATAEEPROM_Erase(uint32_t Address)
{
  ...
  if(status == HAL_OK)
  {
    ...
    pFlash.ErrorCode = 0x00U;
      ...
      *(volatile uint32_t *) Address = 0x00000000U;
...
# 719 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_DATAEEPROM_Program(uint32_t TypeProgram, uint32_t Address, uint32_t Data)
{
  HAL_StatusTypeDef status = HAL_ERROR;
  ...
  if(status == HAL_OK)
  {
    ...
    else if(TypeProgram == (0x01U))
    {

      *(volatile uint16_t *)Address = (uint16_t) Data;
    }
    else if(TypeProgram == (0x00U))
    {
...
void HAL_FLASHEx_DATAEEPROM_EnableFixedTimeProgram(void)
{
  ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->PECR) |= ((0x1UL << (8U))));
}
...
static HAL_StatusTypeDef FLASH_OB_RDPConfig(uint8_t OB_RDP)
{
  ...
  tmp1 = (uint32_t)(((OB_TypeDef *) (0x1FF80000UL))->RDP & ((~(0xFFUL << (0U))) & 0x0000FFFF));
...
static HAL_StatusTypeDef FLASH_OB_BORConfig(uint8_t OB_BOR)
{
  ...
  tmp1 = ((OB_TypeDef *) (0x1FF80000UL))->USER & ((~(0xFUL << (16U))) >> 16U);
  ...
  if(status == HAL_OK)
  {
    ...
    ((OB_TypeDef *) (0x1FF80000UL))->USER = tmp;
...
static HAL_StatusTypeDef FLASH_OB_BOOTBit1Config(uint8_t OB_BootBit1)
{
  ...
  tmp1 = ((OB_TypeDef *) (0x1FF80000UL))->USER & ((~(0x1UL << (31U))) >> 16U);
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR & (0x7UL << (20U))) >> 16U);
}
# 957 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
static uint8_t FLASH_OB_GetRDP(void)
{
  uint8_t rdp_level = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR) & ((0xFFUL << (0U))));

  if ((rdp_level != ((uint8_t)0xAA)) && (rdp_level != ((uint8_t)0xCC)))
  {
    return (((uint8_t)0xBB));
  }
  else
...
static uint8_t FLASH_OB_GetBOR(void)
{
  ...
  return (uint8_t)((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR & (uint32_t)(0xFUL << (16U))) >> 16U);
}
...
static uint8_t FLASH_OB_GetBOOTBit1(void)
{
  ...
  return (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->OPTR & (0x1UL << (31U))) >> (31U);
...
static uint32_t FLASH_OB_GetWRP2(void)
{
  ...
  return (uint32_t)(((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->WRPR2);
}
# 1025 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_ProtectedSectorsConfig(uint32_t Sector, uint32_t Sector2, uint32_t NewState)
# 1038 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t WRP_Data = 0;
  ...
  if(status == HAL_OK)
  {
    ...
    {
      if ((OB_WRP & (0x0000FFFFU)) != 0x00000000U)
      {
        if (NewState != (0x00U))
        {
          WRP_Data = (uint16_t)(((OB_WRP & (0x0000FFFFU)) | ((OB_TypeDef *) (0x1FF80000UL))->WRP01));
          ((OB_TypeDef *) (0x1FF80000UL))->WRP01 = (uint32_t)(~(WRP_Data) << 16U) | (WRP_Data);
        }
        else
        {
          WRP_Data = (uint16_t)(~OB_WRP & ((0x0000FFFFU) & ((OB_TypeDef *) (0x1FF80000UL))->WRP01));
    ...
    if (OB_WRP != 0x00000000U)
    {
      if ((OB_WRP & (0xFFFF0000U)) != 0x00000000U)
      {
        if (NewState != (0x00U))
        {
          WRP_Data = (uint16_t)((((OB_WRP & (0xFFFF0000U)) >> 16U | ((OB_TypeDef *) (0x1FF80000UL))->WRP23)));
          ((OB_TypeDef *) (0x1FF80000UL))->WRP23 = (uint32_t)(~(WRP_Data) << 16U) | (WRP_Data);
        }
        else
        {
          WRP_Data = (uint16_t)((((~OB_WRP & (0xFFFF0000U)) >> 16U & ((OB_TypeDef *) (0x1FF80000UL))->WRP23)));
    ...
    if (OB_WRP != 0x00000000U)
    {
      if ((OB_WRP & (0x0000FFFFU)) != 0x00000000U)
      {
        if (NewState != (0x00U))
        {
          WRP_Data = (uint16_t)(((OB_WRP & (0x0000FFFFU)) | ((OB_TypeDef *) (0x1FF80000UL))->WRP45));
          ((OB_TypeDef *) (0x1FF80000UL))->WRP45 =(uint32_t)(~(WRP_Data) << 16U) | (WRP_Data);
        }
        else
        {
          WRP_Data = (uint16_t)(~OB_WRP & ((0x0000FFFFU) & ((OB_TypeDef *) (0x1FF80000UL))->WRP45));
...
# 1130 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmp = 0, tmp1 = 0;
  ...
  tmp1 = ((OB_TypeDef *) (0x1FF80000UL))->USER & ((~(0x7UL << (20U))) >> 16U);
...
# 1176 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BootConfig(uint8_t OB_BOOT)
{
  HAL_StatusTypeDef status = HAL_OK;
  ...
  tmp1 = ((OB_TypeDef *) (0x1FF80000UL))->USER & ((~(0x1UL << (23U))) >> 16U);
...
void FLASH_PageErase(uint32_t PageAddress)
{
  ...
  *(volatile uint32_t *)(uint32_t)(PageAddress & ~((128U) - 1)) = 0x00000000;
}
