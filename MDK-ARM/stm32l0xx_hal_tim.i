...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c" 2
# 181 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 182 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c" 2
# 202 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 302 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
HAL_StatusTypeDef HAL_TIM_Base_DeInit(TIM_HandleTypeDef *htim)
{
  ...
  do { if (((htim)->Instance->CCER & ((uint32_t)((0x1UL << (0U)) | (0x1UL << (4U)) | (0x1UL << (8U)) | (0x1UL << (12U))))) == 0UL) { (htim)->Instance->CR1 &= ~((0x1UL << (0U))); } } while(0);
# 348 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
HAL_StatusTypeDef HAL_TIM_Base_Start(TIM_HandleTypeDef *htim)
{
  ...
  if ((((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000000UL))) || ((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000400UL))) || ((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00010800UL))) || ((htim->Instance) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00011400UL)))))
  {
...
# 528 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_Base_Start_DMA(TIM_HandleTypeDef *htim, const uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
...
HAL_StatusTypeDef HAL_TIM_OC_DeInit(TIM_HandleTypeDef *htim)
{
  ...
  do { if (((htim)->Instance->CCER & ((uint32_t)((0x1UL << (0U)) | (0x1UL << (4U)) | (0x1UL << (8U)) | (0x1UL << (12U))))) == 0UL) { (htim)->Instance->CR1 &= ~((0x1UL << (0U))); } } while(0);
# 731 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 790 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OC_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 838 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OC_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 867 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OC_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 954 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OC_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 1025 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OC_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, const uint32_t *pData,
                                       uint16_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
...
HAL_StatusTypeDef HAL_TIM_PWM_Init(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->State == HAL_TIM_STATE_RESET)
  {
    ...
    htim->Lock = HAL_UNLOCKED;
# 1313 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
HAL_StatusTypeDef HAL_TIM_PWM_DeInit(TIM_HandleTypeDef *htim)
{
  ...
  do { if (((htim)->Instance->CCER & ((uint32_t)((0x1UL << (0U)) | (0x1UL << (4U)) | (0x1UL << (8U)) | (0x1UL << (12U))))) == 0UL) { (htim)->Instance->CR1 &= ~((0x1UL << (0U))); } } while(0);
# 1359 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 1418 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_PWM_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 1495 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_PWM_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
# 1582 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_PWM_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 1907 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_IC_Init(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->State == HAL_TIM_STATE_RESET)
  {
    ...
    htim->Lock = HAL_UNLOCKED;
# 1940 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 2045 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_IC_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
# 2094 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_IC_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 2123 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_IC_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
# 2283 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_IC_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
# 2716 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
HAL_StatusTypeDef HAL_TIM_OnePulse_Start_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  ...
  (((0x00000000U) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((0x00000000U) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((0x00000000U) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_BUSY)));
  (((0x00000004U) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((0x00000004U) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((0x00000004U) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_BUSY)));
# 2797 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
  ((htim)->Instance->DIER |= ((0x1UL << (1U))));
...
# 2819 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_OnePulse_Stop_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
...
# 2890 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_Encoder_Init(TIM_HandleTypeDef *htim, const TIM_Encoder_InitTypeDef *sConfig)
{
  uint32_t tmpsmcr;
  uint32_t tmpccmr1;
...
HAL_StatusTypeDef HAL_TIM_Encoder_DeInit(TIM_HandleTypeDef *htim)
{
  ...
  do { if (((htim)->Instance->CCER & ((uint32_t)((0x1UL << (0U)) | (0x1UL << (4U)) | (0x1UL << (8U)) | (0x1UL << (12U))))) == 0UL) { (htim)->Instance->CR1 &= ~((0x1UL << (0U))); } } while(0);
# 3023 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 3082 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_Encoder_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  HAL_TIM_ChannelStateTypeDef channel_1_state = (((0x00000000U) == 0x00000000U) ? (htim)->ChannelState[0] : ((0x00000000U) == 0x00000004U) ? (htim)->ChannelState[1] : ((0x00000000U) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
  HAL_TIM_ChannelStateTypeDef channel_2_state = (((0x00000004U) == 0x00000000U) ? (htim)->ChannelState[0] : ((0x00000004U) == 0x00000004U) ? (htim)->ChannelState[1] : ((0x00000004U) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
...
# 3648 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
void HAL_TIM_IRQHandler(TIM_HandleTypeDef *htim)
{
...
# 3836 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 3915 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 4271 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_DMABurst_WriteStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress,
                                              uint32_t BurstRequestSrc, const uint32_t *BurstBuffer, uint32_t BurstLength)
{
...
# 4630 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_DMABurst_MultiReadStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress,
                                                  uint32_t BurstRequestSrc, uint32_t *BurstBuffer,
                                                  uint32_t BurstLength, uint32_t DataLength)
{
...
# 4869 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_GenerateEvent(TIM_HandleTypeDef *htim, uint32_t EventSource)
{
...
# 4906 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_ConfigOCrefClear(TIM_HandleTypeDef *htim,
                                           const TIM_ClearInputConfigTypeDef *sClearInputConfig,
                                           uint32_t Channel)
{
...
# 5036 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_ConfigClockSource(TIM_HandleTypeDef *htim, const TIM_ClockConfigTypeDef *sClockSourceConfig)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
# 5190 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_ConfigTI1Input(TIM_HandleTypeDef *htim, uint32_t TI1_Selection)
{
  uint32_t tmpcr2;
...
# 5222 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_StatusTypeDef HAL_TIM_SlaveConfigSynchro(TIM_HandleTypeDef *htim, const TIM_SlaveConfigTypeDef *sSlaveConfig)
{
...
# 5262 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 5305 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
uint32_t HAL_TIM_ReadCapturedValue(const TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpreg = 0U;
...
# 5389 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
...
# 5998 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_TIM_StateTypeDef HAL_TIM_Base_GetState(const TIM_HandleTypeDef *htim)
{
  return htim->State;
}
...
# 6076 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
HAL_TIM_ChannelStateTypeDef HAL_TIM_GetChannelState(const TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
# 6118 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
void TIM_DMAError(DMA_HandleTypeDef *hdma)
{
...
static void TIM_Base_SetConfig(TIM_TypeDef *TIMx, const TIM_Base_InitTypeDef *Structure)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000000UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000400UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00010800UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00011400UL)))))
  {
...
# 6798 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI1_SetConfig(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICSelection,
                              uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr1;
  ...
  if ((((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000000UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00000400UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00010800UL))) || ((TIMx) == ((TIM_TypeDef *) ((0x40000000UL) + 0x00011400UL)))) != RESET)
  {
    tmpccmr1 &= ~(0x3UL << (0U));
...
# 6845 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI1_ConfigInputStage(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr1;
  uint32_t tmpccer;
...
# 6888 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI2_SetConfig(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICSelection,
                              uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr1;
...
# 6928 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI2_ConfigInputStage(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr1;
  uint32_t tmpccer;
...
# 6971 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI3_SetConfig(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICSelection,
                              uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr2;
...
# 7019 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_TI4_SetConfig(TIM_TypeDef *TIMx, uint32_t TIM_ICPolarity, uint32_t TIM_ICSelection,
                              uint32_t TIM_ICFilter)
{
  uint32_t tmpccmr2;
...
# 7062 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_ITRx_SetConfig(TIM_TypeDef *TIMx, uint32_t InputTriggerSource)
{
  uint32_t tmpsmcr;
...
# 7092 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_ETR_SetConfig(TIM_TypeDef *TIMx, uint32_t TIM_ExtTRGPrescaler,
                              uint32_t TIM_ExtTRGPolarity, uint32_t ExtTRGFilter)
{
  uint32_t tmpsmcr;
...
# 7122 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_tim.c"
static void TIM_CCxChannelCmd(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t ChannelState)
{
  uint32_t tmp;
