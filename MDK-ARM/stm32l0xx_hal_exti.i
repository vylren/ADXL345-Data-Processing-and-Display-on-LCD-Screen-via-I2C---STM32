# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c" 2
# 86 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
...
# 87 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c" 2
# 142 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  uint32_t regval;
  uint32_t linepos;
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    {
      ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR &= ~maskline;
    ...
    {
      ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR &= ~maskline;
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24u) | (0x02uL << 24u))) == ((0x04uL << 24u) | (0x02uL << 24u)))
    {
      ...
      regval = ((SYSCFG_TypeDef *) ((0x40000000UL) + 0x00010000UL))->EXTICR[linepos >> 2u];
      regval &= ~((0xFUL << (0U)) << ((4U) * (linepos & 0x03u)));
      regval |= (pExtiConfig->GPIOSel << ((4U) * (linepos & 0x03u)));
      ((SYSCFG_TypeDef *) ((0x40000000UL) + 0x00010000UL))->EXTICR[linepos >> 2u] = regval;
    }
  }
  ...
  {
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR &= ~maskline;
  ...
  {
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR &= ~maskline;
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR & maskline) != 0x00u)
  {
  ...
  if ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR & maskline) != 0x00u)
  {
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    if ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR & maskline) != 0x00u)
    {
    ...
    if ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR & maskline) != 0x00u)
    {
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR = (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->IMR & ~maskline);


  ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR = (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->EMR & ~maskline);


  if ((hexti->Line & (0x02uL << 24u)) != 0x00u)
  {
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR = (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->RTSR & ~maskline);
    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR = (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->FTSR & ~maskline);
...
# 369 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_RegisterCallback(EXTI_HandleTypeDef *hexti, EXTI_CallbackIDTypeDef CallbackID, void (*pPendingCbfn)(void))
{
...
# 394 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
HAL_StatusTypeDef HAL_EXTI_GetHandle(EXTI_HandleTypeDef *hexti, uint32_t ExtiLine)
{
...
# 434 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  uint32_t regval;
  uint32_t maskline;
  ...
  regval = (((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->PR & maskline);
  if (regval != 0x00u)
  {

    ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->PR = maskline;
...
# 466 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  uint32_t regval;
  uint32_t linepos;
  ...
  regval = ((((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->PR & maskline) >> linepos);
  return regval;
}
# 495 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_exti.c"
void HAL_EXTI_ClearPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  uint32_t maskline;
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *) ((0x40000000UL) + 0x00010400UL))->SWIER = maskline;
}
