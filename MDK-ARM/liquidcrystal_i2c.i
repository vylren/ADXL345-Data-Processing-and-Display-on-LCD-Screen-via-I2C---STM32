# 1 "../Drivers/OLED/liquidcrystal_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/OLED/liquidcrystal_i2c.c" 2
# 1 "../Drivers/OLED/liquidcrystal_i2c.h" 1
...
# 5 "../Drivers/OLED/liquidcrystal_i2c.h" 2
# 60 "../Drivers/OLED/liquidcrystal_i2c.h"
...
# 2 "../Drivers/OLED/liquidcrystal_i2c.c" 2
...
void HD44780_Init(uint8_t rows)
{
  ...
  SendCommand(0x20 | dpFunction);

  dpControl = 0x04 | 0x00 | 0x00;
  HD44780_Display();
  HD44780_Clear();


  dpMode = 0x02 | 0x00;
  SendCommand(0x04 | dpMode);
  DelayUS(4500);
