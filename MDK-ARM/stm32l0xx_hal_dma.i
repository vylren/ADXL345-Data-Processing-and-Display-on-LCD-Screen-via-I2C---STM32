...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_dma.c" 2
...
# 86 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_dma.c" 2
...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  hdma->ChannelIndex = (((uint32_t)hdma->Instance - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x00000000UL) + 0x00000008UL))) / ((uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x00000000UL) + 0x0000001CUL)) - (uint32_t)((DMA_Channel_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x00000000UL) + 0x00000008UL)))) << 2;
  ...
  if(hdma->Init.Direction != (0x1UL << (14U)))
  {
    ...
    ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x00000000UL) + 0x000000A8UL))->CSELR &= ~((0xFUL << (0U)) << (hdma->ChannelIndex & 0x1cU));


    ((DMA_Request_TypeDef *) ((((0x40000000UL) + 0x00020000UL) + 0x00000000UL) + 0x000000A8UL))->CSELR |= (uint32_t) (hdma->Init.Request << (hdma->ChannelIndex & 0x1cU));
  }
