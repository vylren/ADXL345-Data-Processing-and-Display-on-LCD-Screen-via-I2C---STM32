...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c" 2
...
# 39 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c" 2
# 60 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
static void UARTEx_Wakeup_AddressConfig(UART_HandleTypeDef *huart, UART_WakeUpTypeDef WakeUpSelection);
# 148 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_RS485Ex_Init(UART_HandleTypeDef *huart, uint32_t Polarity, uint32_t AssertionTime,
                                   uint32_t DeassertionTime)
{
  uint32_t temp;
...
HAL_StatusTypeDef HAL_UARTEx_EnableClockStopMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR3)) |= (((0x1UL << (23U))))); __set_PRIMASK(primask); } while(0);
...
HAL_StatusTypeDef HAL_UARTEx_EnableStopMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t primask; primask = __get_PRIMASK(); __set_PRIMASK(1); (((huart->Instance->CR1)) |= (((0x1UL << (1U))))); __set_PRIMASK(primask); } while(0);
...
# 524 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint16_t *RxLen,
                                           uint32_t Timeout)
{
  uint8_t *pdata8bits;
...
# 663 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
...
# 740 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
HAL_StatusTypeDef HAL_UARTEx_ReceiveToIdle_DMA(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  HAL_StatusTypeDef status;
...
# 819 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
HAL_UART_RxEventTypeTypeDef HAL_UARTEx_GetRxEventType(UART_HandleTypeDef *huart)
{

  return (huart->RxEventType);
}
# 843 "../Drivers/STM32L0xx_HAL_Driver/Src/stm32l0xx_hal_uart_ex.c"
static void UARTEx_Wakeup_AddressConfig(UART_HandleTypeDef *huart, UART_WakeUpTypeDef WakeUpSelection)
{
  ((void)0U);
